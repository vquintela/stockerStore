...
helpers.indexProd = (numero, actual, actualCategoria, actualSubCategoria) => {
    ...
    if (actual == 1) {
        ...
        element = `<li class="page-item"><a class="page-link" href="/productos/${Number(actual) - 1}?categoria=${actualCategoria}&subCat=${actualSubCategoria}">Previous</a></li>`;
    }
    fragment = fragment + element;
    for (let i = 1; i <= numero; i++) {
        if (i == actual) {
            ...
            element = `<li class="page-item"><a class="page-link" href="/productos/${i}?categoria=${actualCategoria}&subCat=${actualSubCategoria}">${i}</a></li>`;
        }
        fragment = fragment + element;
    }
    if (numero == actual) {
        ...
        element = `<li class="page-item"><a class="page-link" href="/productos/${Number(actual) + 1}?categoria=${actualCategoria}&subCat=${actualSubCategoria}">Next</a></li>`;
    }
    fragment = fragment + element;
    return fragment;
}
